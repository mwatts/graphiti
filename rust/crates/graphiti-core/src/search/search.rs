...
use crate::{
    ...
    nodes::{EntityNode, EpisodicNode, CommunityNode, Node},
    search::{
        SearchConfig, SearchFilters, SearchResults, SearchResult,
...
impl GraphitiSearch {
    ...
    pub async fn search(
        ...
        // Search nodes
        let node_results = self.search_nodes(
            query,
        ...
        // Search episodes
        let episode_results = self.search_episodes(
            query,
        ...
        // Search communities
        let community_results = self.search_communities(
            query,
        ...
        for method in search_methods {
            match method {
                ...
                NodeSearchMethod::Bm25 => {
                    let results = node_fulltext_search(
                        &self.clients,
                        query,
                        filters,
                        group_ids,
